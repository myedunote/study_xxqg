...
import (
	"flag"
	"fmt"
	"github.com/johIanse/study_xxqg/utils/stop"
	"io"
	"math/rand"
	"net/http"
	"os"
	...
	"github.com/johIanse/study_xxqg/conf"
	"github.com/johIanse/study_xxqg/lib/state"
	"github.com/johIanse/study_xxqg/utils"
	// "github.com/johIanse/study_xxqg/gui"
	"github.com/johIanse/study_xxqg/lib"
	"github.com/johIanse/study_xxqg/model"
	"github.com/johIanse/study_xxqg/push"
	"github.com/johIanse/study_xxqg/utils/update"
	"github.com/johIanse/study_xxqg/web"
)
...
func init() {
	...
	if !utils.CheckQuestionDB() {
		...
		//log.Errorln("题库文件不存在或已损坏，请手动前往 https://github.com/johIanse/study_xxqg/blob/main/conf/QuestionBank.db 下载并放入程序根目录")
	}
}
